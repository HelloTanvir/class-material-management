...
import SubjectBtn from './SubjectButton';
...
const Header = () => {
    ...
    return (
        <header className="flex flex-col px-10 py-2 text-gray-700 border-b shadow md:items-center md:justify-between md:flex-row md:px-20 md:py-3">
